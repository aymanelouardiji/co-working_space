...
import com.friendsworkspace.service.DeskService;
...
public class DeskController {
    ...
    public ResponseEntity<Desk> createDesk(@RequestParam Long workspaceId, @Valid @RequestBody com.friendsworkspace.dto.request.DeskRequest deskRequest) {
    ...
    @PreAuthorize("hasRole('SPACE_MANAGER')")
    public ResponseEntity<Desk> updateDeskStatus(@PathVariable Long id, @RequestParam com.friendsworkspace.model.DeskStatus status) {
        return ResponseEntity.ok(deskService.updateDeskStatus(id, status));
    }

    @PutMapping("/{id}")
    @PreAuthorize("hasRole('SPACE_MANAGER')")
    public ResponseEntity<Desk> updateDesk(@PathVariable Long id, @Valid @RequestBody com.friendsworkspace.dto.request.DeskRequest deskRequest) {
