...
import com.friendsworkspace.repository.DeskRepository;
...
public class DeskService {
    ...
    @Transactional
    public Desk createDesk(Long workspaceId, com.friendsworkspace.dto.request.DeskRequest deskRequest) {
    ...
    @Transactional
    public Desk updateDesk(Long id, com.friendsworkspace.dto.request.DeskRequest deskRequest) {
        Desk desk = deskRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Desk not found"));
